<template>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                ...
                <h5 class="card-title">List of the Admin</h5>
  ...
  <script>
  import { getAllAdmin } from '@/services/empData'
  ...
  export default {
    ...
    computed: {
      filteredEmployee: function () {
        return this.LstAdmin.filter((employee) => {
    ...
    methods: {
      async lstAllAdmin() {
        const lstTL = await getAllAdmin()
        console.log('LstTeamLeader', lstTL)
        this.LstAdmin = lstTL
        return this.LstAdmin
      },
