        ...
        <div class="card mb- 4 ">
          <div class="card-body m-4  rounded-3" >
            ...
            <div class="row">
              ...
              <div class="col-sm-8 ">
                <p class="text-muted mb-0">{{ project ? project.ProjectDescription : 'Loading...' }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card mb-4 mb-md-0">
              <!-- <HrProjectTaskStatusCard></HrProjectTaskStatusCard> -->
            </div>
          </div>
          <div class="col-md-6">
            <div class="card mb-4 mb-md-0">
...
export default {
  ...
  // components:{HrProjectTaskStatusCard},
  props: ['ProjectData'],
  data (){
    return{
        getProjectData:[],
  ...
  created() {
    console.log('From Child ProjectData', this.ProjectData);
