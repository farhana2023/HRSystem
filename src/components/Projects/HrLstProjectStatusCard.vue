<template>
    <div class="card-body" v-for="pProgress in pProgressData" :key="pProgress.id">
      ...
      <div >
        <p class="mb-1 bold pt-3" style="font-size: 1.5rem;"><RouterLink :to="{ name:'edit-Project', query: {ProjectID: pProgress.id}}">
                          

                          <span style="color: blue">        {{ pProgress.projectTitle ? pProgress.projectTitle
 : 'Loading...' }}</span>
